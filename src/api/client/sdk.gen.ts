 ...
 */
export const postSpotifyRemoveTrackEndpoint = <ThrowOnError extends boolean = false>(options?: Options<PostSpotifyRemoveTrackEndpointData, ThrowOnError>) => (options?.client ?? client).post<PostSpotifyRemoveTrackEndpointResponses, PostSpotifyRemoveTrackEndpointErrors, ThrowOnError>({
