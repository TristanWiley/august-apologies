...
export const LoginEndpointRequestSchema = z.object({
  code: z.string(),
  redirectURL: z.url(),
});

export const LoginEndpointResponseSchema = z.object({
...
export class LoginEndpoint extends OpenAPIRoute {
  schema = {
    ...
    tags: ["Authentication"],
    request: {
      body: contentJson(LoginEndpointRequestSchema),
    },
    responses: {
      200: {
        description: "Successful login",
        ...contentJson(LoginEndpointResponseSchema),
      },
      400: {
